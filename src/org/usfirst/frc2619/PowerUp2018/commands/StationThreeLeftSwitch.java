 ...
 *
 */
public class StationThreeLeftSwitch extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public StationThreeLeftSwitch() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
    	...
    	addSequential(new DriveXFeetMotionMagic(18));
     	addSequential(new TurnNDegreesAbsolutePID(-85));
     	addSequential(new DriveXFeetMotionMagic(15));
