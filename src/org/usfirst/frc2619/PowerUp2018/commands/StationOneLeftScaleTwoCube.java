 ...
 *
 */
public class StationOneLeftScaleTwoCube extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public StationOneLeftScaleTwoCube() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    	...
    	addSequential(new DriveXFeetMotionMagic(3.5));
    	addSequential(new TurnNDegreesAbsolutePID(135));
    	addParallel(new DriveXFeetMotionMagic(4));
    	addSequential(new RunCollector(.4));
    	addSequential(new DriveXFeetMotionMagic(-3.5));
