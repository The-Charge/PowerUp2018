 ...
 *
 */
public class StationThreeRightScaleOnly extends ConditionalCommand {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
    public StationThreeRightScaleOnly() {
      super(new StationThreeRightScale(), new StationThreeRightSwitchOnly());
