...
public class Elevator extends Subsystem {
	...
	private final static double MOTION_MAGIC_P_CONSTANT = 0.01;
    ...
    private static final int TICKS_TO_TOP = 20000;
	...
	double MotionMagicP = MOTION_MAGIC_P_CONSTANT;
	double MotionMagicI = MOTION_MAGIC_I_CONSTANT;
	double MotionMagicD = MOTION_MAGIC_D_CONSTANT;
	double MotionMagicF = MOTION_MAGIC_F_CONSTANT;
	int MotionMagicVelocity = MOTION_MAGIC_VELOCITY_CONSTANT;
	int MotionMagicAcceleration = MOTION_MAGIC_ACCELERATION_CONSTANT;
	double MotionMagicDistance;
    ...
    public void resetEncoderBottom() {
