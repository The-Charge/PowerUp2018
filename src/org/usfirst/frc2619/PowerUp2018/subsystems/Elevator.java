...
public class Elevator extends Subsystem {
	...
	double MotionMagicP = SPEED_P_CONSTANT;
	double MotionMagicI = SPEED_I_CONSTANT;
	double MotionMagicD = SPEED_D_CONSTANT;
	double MotionMagicF = SPEED_F_CONSTANT;
