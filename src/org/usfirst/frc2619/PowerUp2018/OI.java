...
public class OI {
    ...
    public OI() {
        ...
        elevateToSixBtn = new JoystickButton(buttonBox, 18);
        elevateToSixBtn.whenPressed(new ElevateToXPos(6));
        runShoulderHighBtn = new JoystickButton(buttonBox, 17);
        runShoulderHighBtn.whenPressed(new ShoulderToXPos(.9));
        runShoulderMidHighBtn = new JoystickButton(buttonBox, 16);
        runShoulderMidHighBtn.whenPressed(new ShoulderToXPos(.7));
        runShoulderMiddleBtn = new JoystickButton(buttonBox, 15);
        runShoulderMiddleBtn.whenPressed(new ShoulderToXPos(.5));
        runShoulderLowBtn = new JoystickButton(buttonBox, 14);
        runShoulderLowBtn.whenPressed(new ShoulderToXPos(.3));
        overrideDownBtn = new JoystickButton(buttonBox, 13);
        overrideDownBtn.whileHeld(new OverrideElevator(false));
        overrideUpBtn = new JoystickButton(buttonBox, 12);
        overrideUpBtn.whileHeld(new OverrideElevator(true));
        runCollectorReverseSlowBtn = new JoystickButton(buttonBox, 11);
        runCollectorReverseSlowBtn.whileHeld(new RunCollectorReverse(-.025));
        runCollectorReverseFastBtn = new JoystickButton(buttonBox, 10);
