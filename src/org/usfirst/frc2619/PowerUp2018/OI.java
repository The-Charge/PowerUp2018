...
public class OI {
    ...
    public OI() {
        ...
        bbRunCollectorBtn = new JoystickButton(buttonBox, 9);
        bbRunCollectorBtn.whileHeld(new RunCollectorForward());
        ...
        runCollectorBtn = new JoystickButton(rightJoystick, 1);
        runCollectorBtn.whileHeld(new RunCollectorForward());
        ...
        leftRunCollectorBtn = new JoystickButton(leftJoystick, 1);
        leftRunCollectorBtn.whileHeld(new RunCollectorForward());
