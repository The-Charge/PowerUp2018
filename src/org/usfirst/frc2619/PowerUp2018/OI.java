...
public class OI {
    ...
    public OI() {
        ...
        clawAndCollectorBtn = new JoystickButton(buttonBox, 15);
        clawAndCollectorBtn.whileHeld(new ClawAndCollector());
        lowerShoulderBtn = new JoystickButton(buttonBox, 12);
        lowerShoulderBtn.whenReleased(new LowerShoulder());
        raiseShoulderBtn = new JoystickButton(buttonBox, 12);
        raiseShoulderBtn.whenPressed(new RaiseShoulder());
        overrideUpBtn = new JoystickButton(buttonBox, 8);
        overrideUpBtn.whileHeld(new OverrideElevator(true));
        overrideDownBtn = new JoystickButton(buttonBox, 9);
        overrideDownBtn.whileHeld(new OverrideElevator(false));
        runCollectorReverseSlowBtn = new JoystickButton(buttonBox, 17);
        runCollectorReverseSlowBtn.whileHeld(new RunCollectorReverse(-.05));
        runCollectorReverseFastBtn = new JoystickButton(buttonBox, 16);
        runCollectorReverseFastBtn.whileHeld(new RunCollectorReverse(-.37));
        runCollectorForwardBtn = new JoystickButton(buttonBox, 13);
        runCollectorForwardBtn.whileHeld(new RunCollectorForward());
        elevateToFourBtn = new JoystickButton(buttonBox, 1);
        elevateToFourBtn.whenPressed(new ElevateToXPos(4));
        elevateToThreeBtn = new JoystickButton(buttonBox, 2);
        elevateToThreeBtn.whenPressed(new ElevateToXPos(3));
        elevateToTwoBtn = new JoystickButton(buttonBox, 3);
        ...
        elevateToZeroBtn = new JoystickButton(buttonBox, 5);
        elevateToZeroBtn.whenPressed(new ElevateToXPos(0));
        closeClawBtn = new JoystickButton(buttonBox, 14);
        closeClawBtn.whenReleased(new CloseClaw());
        openClawBtn = new JoystickButton(buttonBox, 14);
